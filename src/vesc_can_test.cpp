...
int main(int argc, char *argv[])
{
  ...
  // while(vesc_dev.m_pack != vesc_can_driver::CAN_PACKET_PROCESS_RX_BUFFER)
  // {
  //     asm ("nop");
  // }
  ...
  {
    // if(vesc_dev.status_.connection_state != vesc_can_driver::CONNECTED)
    // {
    //     printf("VESC disconnected midway\n");
    //     break;
    // }
    vesc_dev.setDutyCycle(0.5);
